...
$_lang['ms2_prop_groupByGroups'] = 'Группировать ли вывод опций ("1" для группировки)';
$_lang['ms2_prop_groupSeparator'] = 'Разделитель между группами опций';
$_lang['ms2_prop_tplGroup'] = 'Шаблон оформления группы опций';
