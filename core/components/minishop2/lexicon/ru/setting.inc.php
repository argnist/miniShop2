...
$_lang['setting_ms2_product_sku_grid_fields'] = 'Колонки в таблице торговых предложений';
$_lang['setting_ms2_product_sku_grid_fields_desc'] = 'Список колонок в таблице торговых предложений, через запятую. Например: "price,color,weight".';
